...
func startIPv4TCPMountV3Server(port uint16, publish bool, callbacks MountV3Interface) (published bool, err error) {
	...
	err = oncserver.StartServer(onc.IPProtoTCP, port, []oncserver.ProgVersStruct{{Prog: onc.ProgNumMount, VersList: []uint32{3}}}, &requestHandlerStruct{})
	if nil != err {
		return
	}
...
func startIPv4UDPMountV3Server(port uint16, publish bool, callbacks MountV3Interface) (published bool, err error) {
	...
	err = oncserver.StartServer(onc.IPProtoUDP, port, []oncserver.ProgVersStruct{{Prog: onc.ProgNumMount, VersList: []uint32{3}}}, &requestHandlerStruct{})
	if nil != err {
		return
	}
...
func startIPv4TCPNFSv3Server(port uint16, publish bool, callbacks NFSv3Interface) (published bool, err error) {
	...
	err = oncserver.StartServer(onc.IPProtoTCP, port, []oncserver.ProgVersStruct{{Prog: onc.ProgNumNFS, VersList: []uint32{3}}}, &requestHandlerStruct{})
	if nil != err {
		return
	}
...
func startIPv4UDPNFSv3Server(port uint16, publish bool, callbacks NFSv3Interface) (published bool, err error) {
	...
	err = oncserver.StartServer(onc.IPProtoUDP, port, []oncserver.ProgVersStruct{{Prog: onc.ProgNumNFS, VersList: []uint32{3}}}, &requestHandlerStruct{})
	if nil != err {
		return
	}
